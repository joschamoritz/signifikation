# Golden-Query-Report: Phase C – wiki_mc3
...
| # | Test | Status | Detail |
|---|---|---|---|
| 1 | Lüge + OBJA-Kollokatoren | FAIL | 'auftischen' fehlt: ['beginnen', 'erzählen', 'strafen', 'verbreiten'] |
| 2 | Elend → Substantiv (POS-Mehrheit) | PASS | Substantiv dominiert: {'Adjektiv': 216, 'Substantiv': 780} |
| 3 | grün (Adj.) → ~PRED-Einträge | PASS | ~PRED vorhanden: ['bleiben'] |
| 4 | Tisch + ATTR | PASS | rund+gedeckt vorhanden, 14 ATTR-Kollokatoren, logDice plausibel |
...
|---|---|---|
| collocations | 794,838 | 9,311,475 |
| distinct_lemma | 48,004 | – |
| lemma_corpus_freq | 1,234,895 | – |
| zeitreise_zeilen | 595,771 | – |
| zeitreise_dekaden | 41 | – |
| wortprofil_db_bytes | 429 MB | 3 GB |
| dokumente | 34,841 | – |
| saetze | 1,386,714 | – |
| quellen | 21 | – |
