# Golden-Query-Report: Phase C – mc1

Erstellt: 2026-07-24 12:53

**10 PASS · 0 FAIL · 1 SKIP** (von 11 Tests)

| # | Test | Status | Detail |
|---|---|---|---|
| 1 | Lüge + OBJA-Kollokatoren | PASS | auftischen vorhanden, tischen fehlt (41 Kollokatoren) |
| 2 | Elend → Substantiv (POS-Mehrheit) | PASS | Substantiv dominiert: {'Adjektiv': 212, 'Substantiv': 737} |
| 3 | grün (Adj.) → ~PRED-Einträge | PASS | ~PRED vorhanden: ['agieren', 'anheben', 'aussehen', 'bleiben', 'erscheinen', 'fangen'] |
| 4 | Tisch + ATTR | PASS | rund+gedeckt vorhanden, 89 ATTR-Kollokatoren, logDice plausibel |
...
|---|---|---|
| collocations | 5,841,990 | 9,311,475 |
| distinct_lemma | 452,504 | – |
| lemma_corpus_freq | 896,184 | – |
| zeitreise_zeilen | 595,771 | – |
| zeitreise_dekaden | 41 | – |
| wortprofil_db_bytes | 2 GB | 3 GB |
| dokumente | 34,841 | – |
| saetze | 1,386,714 | – |
| quellen | 21 | – |
