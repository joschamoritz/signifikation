# Golden-Query-Report: Phase C – wiki_mc5
...
| # | Test | Status | Detail |
|---|---|---|---|
| 1 | Lüge + OBJA-Kollokatoren | FAIL | 'auftischen' fehlt: ['strafen'] |
...
| 4 | Tisch + ATTR | PASS | rund+gedeckt vorhanden, 9 ATTR-Kollokatoren, logDice plausibel |
...
|---|---|---|
| collocations | 388,635 | 9,311,475 |
| distinct_lemma | 25,908 | – |
| lemma_corpus_freq | 1,234,895 | – |
| zeitreise_zeilen | 595,771 | – |
| zeitreise_dekaden | 41 | – |
| wortprofil_db_bytes | 323 MB | 3 GB |
| dokumente | 34,841 | – |
| saetze | 1,386,714 | – |
| quellen | 21 | – |
