            ...
            <div className="konto-auth-socials">
              ...
              <div className="konto-auth-socials-actions">
                ...
                {authOptions.appleEnabled && (
                  ...
                  >
                    <svg aria-hidden="true" height="18" viewBox="0 0 16 20" width="14" fill="currentColor">
                      <path d="M13.66 14.05c-.27.62-.59 1.19-.96 1.71-.5.71-.91 1.2-1.23 1.47-.49.45-1.02.68-1.59.7-.41 0-.9-.12-1.47-.36-.57-.24-1.09-.36-1.57-.36-.5 0-1.04.12-1.62.36-.58.24-1.05.37-1.41.38-.55.02-1.09-.22-1.62-.72-.34-.29-.77-.8-1.28-1.53-.55-.78-1-1.68-1.36-2.71C.18 12.06 0 11.07 0 10.11c0-1.1.24-2.05.71-2.85.37-.64.87-1.15 1.48-1.52a3.97 3.97 0 0 1 2-.57c.44 0 1.01.14 1.72.4.71.27 1.16.4 1.36.4.15 0 .65-.16 1.51-.47.81-.29 1.49-.41 2.05-.36 1.51.12 2.65.72 3.4 1.79-1.35.82-2.02 1.97-2.01 3.45.01 1.15.43 2.1 1.25 2.86.37.35.79.62 1.25.81-.1.29-.21.57-.32.83zM10.7 1.21c0 .82-.3 1.59-.9 2.3-.72.85-1.6 1.34-2.55 1.26-.01-.1-.02-.21-.02-.32 0-.79.34-1.63.95-2.32.3-.35.7-.64 1.17-.87.47-.23.92-.36 1.34-.38.01.11.01.22.01.33z"/>
                    </svg>
                    Mit Apple anmelden
                  </button>
                )}
